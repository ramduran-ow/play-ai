const STRINGS = {
    P_BLOCK: 'Welcome to PLAY, these pages are dedicated to an active and open exploration of Generative AI through its most interesting use cases in our field, creative consulting.',
