const STRINGS = {
    P_BLOCK: 'Welcome to Play, our active and open exploration of Artificial Intelligence and its most interesting use cases in our field, creative consulting. We’re excited to see you.',
    P_BLOCK_2: 'Arf! Glad you\'re here at Play, where we dig into the wonders of AI and discover its most fascinating applications in our creative consulting realm. Tail\'s a-waggin\' to have you with us!',
    P_BLOCK_3: 'Sup, fam! Welcome to Play! 🙌  We\'re all about getting into the zone with Artificial Intelligence and exploring its coolest uses in creative consulting. So glad you\'re here, can\'t wait to vibe together!" 🚀',
    ...
    ARTICLE_SUBHEADER_3: 'BY AUTHOR NAME',
