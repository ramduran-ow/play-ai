...
import {
  TransformingContent,
  ImgBox,
} from "../../interactions/TransformingContent";
...
const ManifestoSection = ({ images, handlePlayerChange, selectedPlayer }) => {
  ...
  sectionHeights = sectionHeights.map(function (x) {
    return x * heightsScalar;
  });
  ...
  const sectionTimings = [
    ...
    [
      ...
      [-4 / 12, -3 / 24, -1 / 24, 2 / 12],
      [-1 / 12, 7 / 24, 9 / 24, 7 / 12],
      [4 / 12, 13 / 24, 15 / 24, 10 / 12],
      [6 / 12, 17 / 24, 19 / 24, 12 / 12],
      [8 / 12, 21 / 24, 23 / 24, 14 / 12],
      [],
      //12 Avocado Toast Movement                   13 Avocado Toast Opacity                           14 Avocado Left Motion
      [-1 / 12, -1 / 12 + 2 / 14, 16 / 14, 18 / 14],
      [-1 / 12, -1 / 12 + 1 / 14, 3 / 14, 3 / 14, 5 / 14, 21 / 14],
      [5 / 14, 20 / 14],
      [11 / 14, 18 / 14],
    ],
    // Empty
  ...
  const sum =
    sectionHeights.reduce((partialSum, a) => partialSum + a, 0) +
    startHeight +
    endblock;
  const sh = startHeight / sum;
  for (let i = 0; i < sectionHeights.length; i++) {
    let start =
      sectionHeights.slice(0, i).reduce((partialSum, a) => partialSum + a, 0) /
        sum +
      sh;
  ...
  const introParagraphs = (
    <>
      <TransformingTextBox
        positions={[6, 6, 6]}
        scrollInfo={adjustedTimings[0][0]}
        alignment={"top"}
        specialWidth={"82rem"}
        child={
          <ScrollingColumn scrollInfo={adjustedTimings[0][0]}>
            <OpacitySubheading
              scrollInfo={adjustedTimings[0][6]}
              center
              fadeRatio={0.8}
              text={[
                <p>
                  ...
                  <br />
                  <br />
                  While we're all for tossing predictions around like avocado
                  toast recipes on Instagram, what if the truth is somewhere
                  between the fantasy and the fear mongering?
                </p>,
              ]}
            />
          </ScrollingColumn>
      ...
      <TransformingTextBox
        positions={[27, 27, 27]}
        scrollInfo={adjustedTimings[0][2]}
        alignment={"top"}
        specialWidth={"78rem"}
        child={
          <ScrollingColumn scrollInfo={adjustedTimings[0][2]}>
            <OpacitySubheading
              scrollInfo={adjustedTimings[0][8]}
              center
              fadeRatio={0.8}
              text={[
                <p>
      ...
      <TransformingTextBox
        positions={[27, 27, 27]}
        scrollInfo={adjustedTimings[0][4]}
        alignment={"top"}
        specialWidth={"93rem"}
        child={
          <ScrollingColumn scrollInfo={adjustedTimings[0][4]}>
            <OpacitySubheading
              scrollInfo={adjustedTimings[0][10]}
              center
              fadeRatio={0.8}
              text={[
                <p>
                  There are plenty of things about AI we don't know, but one
                  thing do:
                  <br />
                  <br />
                  AI is not going to take your next job, but a person who knows
                  how to use it just might
                </p>,
              ]}
            />
          </ScrollingColumn>
  ...
  const avocados = (
    <>
      <OpacityContent
        scrollInfo={adjustedTimings[0][13]}
        child={
          <TransformingContent
            child={
              <ImgBox
                url={images.avocado_toast}
                displayDimensions={[58, 84]}
                rotate={0}
              />
            }
            positions={[
            ...
            scrollInfo={adjustedTimings[0][12]}
      ...
      <TransformingContent
        child={
          <ImgBox
            url={images.avocado_3}
            displayDimensions={[20, 38]}
            rotate={0}
          />
        }
        positions={[
        ...
        scrollInfo={adjustedTimings[0][14]}
        alignment={["left", "bottom"]}
      />
      <TransformingContent
        child={
          <ImgBox
            url={images.avocado_1}
            displayDimensions={[15, 30]}
            rotate={33}
          />
        }
        positions={[
        ...
        scrollInfo={adjustedTimings[0][15]}
  ...
  const mobileRobots = (
    <>
      <TransformingContent
        child={
          <ImgBox
            url={images.cute_robot1}
            displayDimensions={[50, 40]}
            rotate={195}
          />
        }
        positions={[
        ...
        scrollInfo={adjustedTimings[3][10]}
        alignment={["left", "top"]}
      />
      <TransformingContent
        child={
          <ImgBox
            url={images.tin_robot3}
            displayDimensions={[40, 40]}
            rotate={30}
          />
        }
        positions={[
      ...
      <TransformingContent
        child={
          <ImgBox
            url={images.orange_robot1}
            displayDimensions={[45, 40]}
            rotate={-30}
          />
        }
        positions={[
  ...
  const desktopBeach = (
    <OpacityContent
      baseOpacity={0}
      scrollInfo={adjustedTimings[3][11]}
      child={
        <TransformingContent
          child={
            <ImgBox
              url={images.robot_beach}
              displayDimensions={[174, 65]}
              rotate={0}
            />
          }
          positions={[
          ...
          scrollInfo={adjustedTimings[3][5]}
          alignment={["left", "bottom"]}
        />
      }
    />
  ...
  const desktopCreativity = (
    <TransformingTextBox
      positions={[27, 27, 27]}
      scrollInfo={adjustedTimings[2][0]}
      alignment={"top"}
      child={
        <ScrollingColumn scrollInfo={adjustedTimings[2][0]}>
          <OpacitySubheading
            scrollInfo={adjustedTimings[2][1]}
            dark={false}
            text={["Creativity creates progress"]}
          />
          <OpacityParagraph
            scrollInfo={adjustedTimings[2][1]}
            dark={false}
            text={[
              <p>
                Clamping down now is a bit like the church putting Galileo under
                house arrest for creating alternative models of the solar
                system: it's a defensive reflex. While we can't fully predict in
                abstract how AI will affect our businesses, ongoing and
                exploratory participation can help us determine how best to
                integrate it into our daily professional lives.
                <br />
                <br />
                Enough ink has been spilled on the power of AI. The disruption
                of AI. The hypothesis of how AI will change everything. But
                who's experimenting? As creatives and consultants have a duty to
                chart a course beyond convention. In short, we can play.
              </p>,
            ]}
          />
        </ScrollingColumn>
  ...
  const mobileWeChoose = (
    <TransformingTextBox
      positions={[27, 27]}
      scrollInfo={adjustedTimings[3][0]}
      alignment={"top"}
      child={
        <ScrollingColumn scrollInfo={adjustedTimings[3][12]}>
          <OpacitySubheading
            scrollInfo={adjustedTimings[3][1]}
            dark={false}
            baseOpacity={0}
            text={["We choose play"]}
          />
  ...
  const mobileHowWell = (
    <TransformingTextBox
      positions={[27, 27]}
      scrollInfo={adjustedTimings[3][7]}
      alignment={"top"}
      child={
        <ScrollingColumn scrollInfo={adjustedTimings[3][13]}>
          <OpacitySubheading
            scrollInfo={adjustedTimings[3][2]}
            dark={false}
            text={["Where we'll play"]}
          />
          <OpacityList
            scrollInfo={adjustedTimings[3][2]}
            dark={false}
  ...
  const mobileHowPlay = (
    <TransformingTextBox
      positions={[27, 27]}
      scrollInfo={adjustedTimings[3][4]}
      alignment={"top"}
      child={
        <>
          <OpacitySubheading
            scrollInfo={adjustedTimings[3][9]}
            dark={false}
            text={["How we'll play"]}
          />
          <OpacityParagraph
          ...
          />
          <OpacityParagraph
            scrollInfo={adjustedTimings[3][6]}
            dark={false}
            text={[
  ...
  return (
    <section className="manifesto">
      ...
      <Transition
        scrollInfo={[0.6, 0.65, 0.68, 0.73]}
        background={images.manifesto_gradient}
        solidBackground
      />
      {avocados}
      {introParagraphs}
