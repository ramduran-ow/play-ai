...
function ManifestoSection({ images }) {
    ...
    //Heights
    const sectionHeights = [600, 500, 600]

    //Timings | Timings are adjusted to start - end of section
    const sectionTimings = [
        //0 P1 Motion        1 P2 Motion            2 P3 Motion            3 P4 Motion            4 P5 Motion            5 P6 Motion            6 P1 Opacity                 7 P2 Opacity                      8 P3 Opacity                      9 P4 Opacity                       10 P5 Opacity                       11 P6 Opacity
        [[0, 1 / 7, 2 / 7], [1 / 7, 2 / 7, 3 / 7], [2 / 7, 3 / 7, 4 / 7], [3 / 7, 4 / 7, 5 / 7], [4 / 7, 5 / 7, 6 / 7], [5 / 7, 6 / 7, 7 / 7], [0, 1 / 14, 3 / 14, 4 / 14], [1 / 14, 3 / 14, 5 / 14, 7 / 14], [3 / 14, 5 / 14, 7 / 14, 8 / 14], [5 / 14, 7 / 14, 9 / 14, 11 / 14], [7 / 14, 9 / 14, 11 / 14, 13 / 14], [9 / 14, 11 / 14, 13 / 14, 14 / 14]],
    ...
    return (
        <div style={{ position: "relative", height: "100%", width: "100%" }}>
            ...
            <TransformingTextBox positions={[0, 0, 0, 0]} scrollInfo={adjustedTimings[0][0]} alignment={'center'} child={
                <OpacitySubheading scrollInfo={adjustedTimings[0][6]} simpleFade={true} baseOpacity={0} text={
            ...
            {/* <TransformingTextBox positions={[0, 0, 0, 0]} scrollInfo={adjustedTimings[1][5]} alignment={'center'} child={
                <OpacitySubheading scrollInfo={adjustedTimings[1][5]} simpleFade={true} baseOpacity={0} text={
                    ["To say the least, Artificial Intelligence has become one of the most transformative things to ever happen to modern society—rivaling everything that's come before it."]
                } />
            } /> */}
